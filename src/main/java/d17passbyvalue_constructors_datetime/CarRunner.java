...
public class CarRunner {
    public static void main(String[] args) {
       ...
       Car c1 = new Car("BMW","3.20",2024,false); // default constructor //custom constructor
        ...
        System.out.println(c1); //@7a81197d //Car{brand='BMW', model='3.20', year=2024, hybrid=false}
        System.out.println(c2); //@5ca881b5 //Car{brand='Audi', model='A5', year=2018, hybrid=false}

        //Java’da toString metodu genellikle bir nesnenin (object-c1,c2) içeriğini
        // okunabilir bir String olarak döndürmek için kullanılır.
        //--------------------
        Car c3 = new Car("Fiat", "Sahin");
        System.out.println(c3);
        //Car{brand='Fiat', model='Sahin', year=2023, hybrid=true}
